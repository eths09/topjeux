...
<html>
  <head>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="Descriptif_Days_Gone.css" />
  ...
  <body>
    ...
    <nav2>
      <span class="acceuil"><a href="../../../Top_Jeux_Ps4.php"><p>retour acceuil</p></a></span>
    </nav2>
    <footer>
      <p>Days Gone est un jeu vidéo de tir à la troisième personne d'action-aventure du genre survival horror développé par SIE Bend Studio et édité par Sony Interactive Entertainment, sorti le 26 avril 2019 sur PlayStation 41,2.Il se déroule dans un contexte apocalyptique dans le nord-ouest des États-Unis</p></p>
    </footer>   
  </body>    
</html>